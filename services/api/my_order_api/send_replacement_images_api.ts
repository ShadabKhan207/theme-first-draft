...
{
    console.log("my orders in send api", images);
    let response:any;
    ...
    await client.post(`${CONSTANTS.API_BASE_URL}/api/method/sportnetwork.api.map.version_mapper`, raw_data, config).then((res)=>{
